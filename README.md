...
## Installation
The script in this repo lets you run a Terraria server on termux. It has been updated from the original to enable choosing which version you would like to run. To change the server version download the tserver file, or fork this repo, and edit the "Version Config" section of the tserver script. 
